...
//             <div className={styles.filldiv} onClick={triggerFileSelect}>
...
// // code with payload for sinnglr file
// import { Idget } from "../../API/idget";
// import React, { useState, useEffect, useRef } from "react";
// import { io } from "socket.io-client";
// import EmojiPicker from "emoji-picker-react";
...
//   // const handleSendMessage = () => {
//   //   if ((!message.trim() && imgforserver.length === 0) || !userId || !selectedChat?.reciverobjectid) {
//   //     console.error("Missing required data:", { message, userId, selectedChat, imgforserver });
//   //     return;
//   //   }
...
//   //   const newMessage = { sender: "You", text: message || `http://localhost:3000${imageUrls}`, time: formattedTime, imageUrl: imageUrls ? `http://localhost:3000${imageUrls}` : null };
//   //   setChatMessages((prevMessages) => [...prevMessages, newMessage]);
...
//   //     // imageUrl: imageUrls.length > 0 ? imageUrls[imageUrls.length - 1] : null,
//   //     imageUrl: imageUrls ? `http://localhost:3000${imageUrls}`: null,
//   //   });
...
//       text: message || null,
//       time: formattedTime,
//       imageUrl: `http://localhost:3000${imageUrl}` || null,
//     };
  
//     setChatMessages((prevMessages) => [...prevMessages, newMessage]);
//   console.log("imha",imageUrl);
//     socket.emit("privateMessage", {
//       reciverId,
//       senderId: userId,
//       receiverobjectId: selectedChat.reciverobjectid,
...
//     const handleIncomingMessage = ({ senderIdbyserver, message, time, imageUrls }) => {
//       const formattedTime = new Date(time).toLocaleString("en-US", {
//         hour: "numeric",
//         minute: "numeric",
//         hour12: true,
...
//       // If the message is from the receiver and has an image URL, display the image
//       if (senderIdbyserver === reciverId) {
...
//       const uploadedImageUrl = result.imageUrl; // Get the image URL after successful upload.
...
//     >
//       {msg.imageUrl ? (
//         <img src={msg.imageUrl}alt="Sent Image" className={styles.chatImage} />
//       ) : (
//         <p>
//           {msg.text} <span>{msg.time}</span>
//         </p>
